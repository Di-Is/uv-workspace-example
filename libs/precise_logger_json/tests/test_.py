...
# テスト対象のクラス(実装済みの PreciseTimestampFormatter)
...
def test_formatter_with_fraction_digits_3():
    ...
    tz = "Asia/Tokyo"
    formatter = PreciseTimestampJsonFormatter(frac_digits=3, tz=tz)
...
def test_formatter_with_fraction_digits_6():
    ...
    tz = "Asia/Tokyo"
    formatter = PreciseTimestampJsonFormatter(frac_digits=6, tz=tz)
    record = create_log_record(created_time)
    formatted_time = formatter.formatTime(record)
...
def test_formatter_with_fraction_digits_9():
    ...
    created_time = 1672531200.123456
    tz = "Asia/Tokyo"
    formatter = PreciseTimestampJsonFormatter(frac_digits=9, tz=tz)
    record = create_log_record(created_time)
    formatted_time = formatter.formatTime(record)
...
def test_formatter_with_no_fraction():
    ...
    created_time = 1672531200.123456
    tz = "Asia/Tokyo"
    formatter = PreciseTimestampJsonFormatter(frac_digits=0, tz=tz)
    record = create_log_record(created_time)
    formatted_time = formatter.formatTime(record)
...
def test_formatter_with_local_timezone():
    ...
    """
    created_time = 1672531200.123456
    formatter = PreciseTimestampJsonFormatter(frac_digits=3, tz=None)
    record = create_log_record(created_time)
    formatted_time = formatter.formatTime(record)
